    ...
    <section id="contact" className="contact py-48">
      ...
      <div className="md:flex md:justify-between gap-16 mt-5">
        ...
        >
          ...
          <img src={contact} alt="contact" className="saturate-150" />
        </motion.div>
        ...
        >
          ...
          >
            ...
            <button
              className="p-5 bg-yellow font-semibold text-deep-blue mt-5 hover:bg-red cursor-pointer hover:text-white transition duration-500"
              type="submit"
            >
              SEND ME A MESSAGE
            </button>
